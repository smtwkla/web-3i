...
def hello_world():
    ...
    return f'<html><body><h1>Paddle Amps:{amps}</h1>Timestamp: {ts}<script  language="javascript" type="text/javascript" setTimeout(function() {{ window.location=window.location;}},5000);</script></body></html>'
